...
<head>
    ...
    <title>Pagina Web Oier Vicente - Crear Usuario</title>
</head>
    ...
    <?php
                if (isset($_SESSION["rolUsuario"]) && (!empty($_SESSION["rolUsuario"]))) {
                    if ($_SESSION["rolUsuario"] == 2) {
                                ...
                                echo
                                    "<form action='./../phps/crearUsuario.php' method='post'>
                                        <div class='form-group row'>
                                            <label class='col-sm-2 col-form-label'>Nombre del usuario</label>
                                            <div class='col-sm-10'>
                                                <input type='text' class='form-control' maxlength='75' name='nombreUsuario' required>
                                            </div>
                                        </div>
                                        <div class='form-group row'>
                                            <label class='col-sm-2 col-form-label'>Contraseña del usuario</label>
                                            <div class='col-sm-10'>
                                            <input type='text' class='form-control' maxlength='75' name='contrasenaUsuario' required>
                                            </div>
                                        </div>
                                        <div class='form-group row'>
                                            <label class='col-sm-2 col-form-label'>Email del usuario</label>
                                            <div class='col-sm-10'>
                                            <input type='email' class='form-control' maxlength='150' name='emailUsuario' required>
                                            </div>
                                        </div>
                                        <div class='form-group row'>
                                        <label class='col-sm-2 col-form-label'>Rol del usuario</label>
                                        <div class='col-sm-10'>
                                            <select class='custom-select custom-select-lg' name='idRolSelect' required>";
                                                ...
                                                if ($result = mysqli_query($conn, $sql)) {
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        while ($fila = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            $descripcionRol = $fila["descripcionRol"];
                                      ...
                                      echo "</select>
                                        ...
                                        <div class='form-group row'>
                                            <div class='col-sm-10'>
                                                <button type='submit' class='btn btn-success'><i class='fas fa-user-plus'></i> Crear un nuevo usuario</button>
                                            </div>
                                        </div>
                                    </form>";
